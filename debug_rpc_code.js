...
async function run() {
    // query pg_proc? We can't via REST API directly usually, unless we use postgres meta
    // But wait! Let me fetch the actual transactions using the authenticated user in puppeteer or just using curl?
    // I can just fix getProductUsageHistory to use pagination for now!
}
run();
