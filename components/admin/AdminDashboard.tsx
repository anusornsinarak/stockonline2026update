...
export const AdminDashboard: React.FC<AdminDashboardProps> = (props) => {
  ...
  const renderContent = () => {
      switch (activeTab) {
          ...
          case 'departments': return <DepartmentView results={data.surveySubmissions} products={data.products} departments={data.departments} onDataChange={() => fetchData(true)} fiscalYear={nextFiscalYearBE} />;
